...
// title
        <div className="w-[1440px] h-[689px] px-[170px] py-[60px] flex-col justify-center items-center gap-[60px] inline-flex">
...
{/* cards */}
          <div className="self-stretch justify-between items-center inline-flex">
            <NewsCard title="新サービスリリースのお知らせ" description="2023/12/15" urlToImage="https://via.placeholder.com/352x247" date="2023/12/15"></NewsCard>
            <NewsCard title="新サービスリリースのお知らせ" description="2023/12/15" urlToImage="https://via.placeholder.com/352x247" date="2023/12/15"></NewsCard>
            <NewsCard title="新サービスリリースのお知らせ" description="2023/12/15" urlToImage="https://via.placeholder.com/352x247" date="2023/12/15"></NewsCard>
          </div>
